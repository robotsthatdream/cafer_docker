...
QtModule {
    ...
    staticLibsRelease: []
    dynamicLibsDebug: []
    dynamicLibsRelease: ["/opt/qt57/lib/libQt5Test.so.5.7.0", "/opt/qt57/lib/libQt5Widgets.so.5.7.0", "/opt/qt57/lib/libQt5Gui.so.5.7.0", "/opt/qt57/lib/libQt5Core.so.5.7.0", "pthread"]
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: []
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/qt57/lib/libQt5QuickTest.so.5.7.0"
